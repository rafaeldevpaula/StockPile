...
Além de manter a coleção organizada, o projeto oferece a possibilidade de atribuir uma nota a cada jogo, guardar pequenas análises ou anotações pessoais e visualizar estatísticas automáticas sobre o estado da sua biblioteca.

Toda a gestão é feita de forma direta e os dados são guardados localmente no próprio navegador do utilizador, proporcionando uma experiência rápida e sem complicações.
